(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/resources/Script/view/games/doushouqi/Doushouqi.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f241fcnZhlAR5aR35LomT+L', 'Doushouqi', __filename);
// resources/Script/view/games/doushouqi/Doushouqi.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        if (!config.isNetwork) {
            ...
            // 网络监听列表
            var listenerList = [[events.game.GAME_DATA, this.onReceive_login, this], [events.game.doushouqi.S2C_START, this.onReceive_start, this], [events.game.doushouqi.S2C_MOVE, this.onReceive_move, this], [events.game.doushouqi.S2C_TALK, this.onReceive_talk, this], [events.game.doushouqi.S2C_ANIMAL, this.onReceive_animal, this], [events.game.doushouqi.S2C_GAMEOVER, this.onReceive_overGame, this], [events.game.doushouqi.S2C_ASK_FOR_DRAW, this.onReceive_qiuHeOther, this], [events.game.doushouqi.S2C_ASK_FOR_DRAW_AGREE, this.onReceive_qiuHeAgreeOther, this]];
    ...
    // 点击箱子后请求到的动物
    onReceive_animal: function onReceive_animal(data1, data2) {
    ...
    onReceive_MyCode: function onReceive_MyCode(data) {
    ...
    // 移动动物
    onReceive_move: function onReceive_move(data1, data2) {
    ...
    // 操作方 暂时不用
    onRecive_doIt: function onRecive_doIt(data1, data2) {},
    ...
    // 求和询问提示
    onReceive_qiuHeOther: function onReceive_qiuHeOther() {

        this._alertStr = consts.game.doushouqi.ASK_FOR_DRAW;

        this.onAddAlert(texts.game.doushouqi.ASK_FOR_DRAW);
    },
    onReceive_qiuHeAgreeOther: function onReceive_qiuHeAgreeOther() {
     ...
     * @packgeName: 发送的数据的包明
     */
    onSendGameData: function onSendGameData(packgeName, data) {

        requestHandler.sendRequest(packgeName, data);
    },

    onReceive_talk: function onReceive_talk(data1, data2) {
    ...
    addButtonListener: function addButtonListener() {
    ...
    onInitTable: function onInitTable() {
        ...
        for (var index = 0; index < this.gameData.length; index++) {

            for (var jndex = 0; jndex < this.gameData[index].length; jndex++) {
    ...
    onCreateAnimal: function onCreateAnimal(index, jndex, animalStatus) {
    ...
    onRandAnimal: function onRandAnimal() {
     ...
     */
    onTouchCallback: function onTouchCallback(row, col, objCode, isSelected) {
    ...
    // 移动后并且删除被吃掉的棋子
    onMoveCallbackDel: function onMoveCallbackDel(moveData) {
    ...
    //  移动结果回调
    onMoveCallback: function onMoveCallback(moveData) {
    ...
    onIsSelfdoit: function onIsSelfdoit() {
    ...
    onStopRepeatAction: function onStopRepeatAction(nodeObj, dirStr) {
    ...
    onNewPlayerGuid: function onNewPlayerGuid() {
     ...
     */
    onActiconHand: function onActiconHand() {
        ...
        var seq = cc.repeatForever(cc.sequence(cc.moveTo(0.85, -50, -50), cc.moveTo(0.5, 0, 0)));
    ...
    // 弹出 确认取消框
    onAddAlert: function onAddAlert(descStr) {
        var labelRedBtn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : texts.game.doushouqi.REFUSE;
        var labelBlueBtn = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : texts.game.doushouqi.AGREE;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=Doushouqi.js.map
