(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/resources/Script/view/hall/LoginScene.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8240cE/b7JCtJliSoxC2Wdv', 'LoginScene', __filename);
// resources/Script/view/hall/LoginScene.js
...
cc.Class({
    ...
    // 隐藏微信登录
    hideWeChatLogin: function hideWeChatLogin() {
        this.btnWeChat.node.active = false;
        this.btnPhone.node.x = 0;
    },

    // 微信登录
    onClickedBtnWechat: function onClickedBtnWechat() {
        var $this = this;
        console.log('微信登录');
    ...
    // 检查微信登录结果
    checkWXLoginResult: function checkWXLoginResult() {
    ...
    // 点击手机
    onClickedBtnPhone: function onClickedBtnPhone() {
        console.log('点击手机');
    ...
    // 点击 同意文字
    onClickedBtnAgree: function onClickedBtnAgree() {
        console.log('点击用户条款');
